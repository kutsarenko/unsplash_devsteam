...
List<PhotosModel> welcomeFromJson(String str) => List<PhotosModel>.from(json.decode(str).map((x) => PhotosModel.fromJson(x)));

String welcomeToJson(List<PhotosModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class PhotosModel {
  ...
  //static PhotosModel fromJason(element) {}
}
